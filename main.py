...
# this argument takes 3 parametesr
# 1 - x: training dataset of feature vectors/raw pixel intesities
# 2 - y: class labels associated with each training data point
# 3 - batchSize: size of each mini-batch to be returned
